...
public class GenerateIdBySnowFlake {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GenerateIdBySnowFlake.class);
    ...
    public GenerateIdBySnowFlake(long workerId, long dataCenterId, long sequence){
