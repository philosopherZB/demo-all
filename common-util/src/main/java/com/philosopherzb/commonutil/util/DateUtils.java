...
public class DateUtils {
    ...
    /**
     * <code>java.time.LocalDate</code> covert to <code>java.util.Date</code>
     * use default zone
     *
     ...
     */
    public static Date stringToDateTimeByFormat(String date, String format) {
    ...
    public static Date stringToDateTimeByDefaultDateFormat(String date) {
        return stringToDateTimeByFormat(date, DEFAULT_DATE_FORMAT);
    }
     ...
     * @return hours
     */
    public static long diffHours(Date srcDate, Date decDate) {
        return (long) Math.ceil(diffMin(srcDate, decDate) / 60.0);
    }
     ...
     * @return minutes
     */
    public static long diffMin(Date srcDate, Date decDate) {
        return (long) Math.ceil(differSec(srcDate, decDate) / 60.0);
    }
